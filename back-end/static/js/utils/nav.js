...
function renderNavUser() {
  ...
  if (user) {
    right.innerHTML = `
      <a href="/profile" class="hidden md:flex items-center gap-2 text-[13px] text-[var(--text2)] hover:text-[var(--text)] transition-colors cursor-pointer no-underline">
    ...
    right.innerHTML = `
      ...
      <a href="/auth?tab=signup" class="btn btn-sm btn-primary hidden md:inline-flex">Sign up</a>`;
  }
}
